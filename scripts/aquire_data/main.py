...
Bare-bones data acquisition pipeline (Step 1):

    angles file (xlsx/csv/txt)
        -> for each angle:
             move motor to angle
             wait for settle
...
OUTPUT_DIR = "run_001"          # created if it doesn't exist
...
def main():
    ...
    motor = Motor(port=MOTOR_PORT, baud=MOTOR_BAUD)
